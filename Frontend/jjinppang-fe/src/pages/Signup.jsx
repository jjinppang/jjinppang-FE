    ...
    <>
      ...
      <div class="w-full h-[1024px] flex items-center justify-center">
        <div
          ...
          class="w-[391px] h-[669px] flex flex-col content-center rounded-[10px] shadow-custom-shadow p-[38px]"
        >
          ...
          <div
            ...
            class="font-[600] mt-[23px] text-base text-left"
          >
            회원정보 입력
          </div>
          ...
          <div className="LoginInput">
            ...
            <input
              ...
              class={`w-314 h-45 border-1 ${
                isEmailValid ? "border-cdcdcd mb-[39px]" : "border-color3"
              } rounded-[10px] px-3 mt-[10px]`}
              type="text"
              id="username"
              name="username"
              value={email}
            ...
            ></input>
            {!isEmailValid && (
              <div class="text-color2 text-[10px] mt-[7px] mb-[20px]">
                이메일 형식을 확인해주세요.
              </div>
            )}
          </div>
          ...
          <div className="PasswordInput">
            ...
            <input
              ...
              class={`w-314 h-45 border-1 ${
                isPasswordValid ? "border-cdcdcd" : "border-color3"
              } mt-[10px] rounded-[10px] px-3`}
              type="password"
              id="password"
              name="password"
              value={password}
            ...
            ></input>
            {!isPasswordValid && (
              <div class="text-color2 text-[10px] mt-[7px]">
                비밀번호는 문자, 숫자, 특수문자를 포함하여 8~20자 이내로
                입력하세요.
              </div>
            )}
            ...
            <input
              ...
              class={`w-314 h-45 border-1 ${
                isConfirmPasswordValid
                  ? "border-cdcdcd mt-[12px] mb-[33px]"
                  : "border-color3 mt-[8px]"
              } rounded-[10px] px-3`}
              type="password"
              id="confirmPassword"
            ...
            ></input>
            {!isConfirmPasswordValid && (
              <div class="text-color2 text-[10px] mt-[7px] mb-[12px]">
                비밀번호가 일치하지 않습니다.
              </div>
            )}
          </div>
          ...
          <button
            ...
            class={`w-314 h-45 rounded-[10px] ${
              isAllValid ? "bg-keyColor" : "bg-color4"
